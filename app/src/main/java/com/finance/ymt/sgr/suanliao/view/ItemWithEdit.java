...
public class ItemWithEdit extends RelativeLayout {

    private TextView text_title,text_unit,text_result;
    private EditText edit_input_number,edit_input_type;
    private String string_text_title,string_unit,string_result;

    public ItemWithEdit(Context context) {
        super(context);
        LayoutInflater.from(context).inflate(R.layout.item_with_edit,this,true);
    ...
    public ItemWithEdit(Context context, AttributeSet attrs) {
        super(context, attrs);
        //
        ////加载视图的布局
       LayoutInflater.from(context).inflate(R.layout.item_with_edit,this,true);
...
//        text_result.setText(string_result);
