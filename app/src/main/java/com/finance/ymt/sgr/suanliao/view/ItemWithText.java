...
public class ItemWithText extends RelativeLayout {
    ...
    public ItemWithText(Context context) {
        super(context);
        LayoutInflater.from(context).inflate(R.layout.item_with_text,this,true);
    ...
    public ItemWithText(Context context, AttributeSet attrs) {
        super(context, attrs);
        //
        ////加载视图的布局
        LayoutInflater.from(context).inflate(R.layout.item_with_text,this,true);
